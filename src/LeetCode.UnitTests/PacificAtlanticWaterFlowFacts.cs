...
{
    [TestClass]
    [TestCategory("0417. Pacific Atlantic Water Flow")]
    public class PacificAtlanticWaterFlowFacts
    {
        [TestMethod]
        public void Example107()
        {
            ...
            var result = solution.PacificAtlantic(matrix);

            var strExpected = "[[0, 29],[1, 28],[2, 27],[2, 28],[3, 27],[34, 2],[35, 2],[35, 3],[36, 1],[36, 2],[37, 0],[37, 2],[37, 3],[38, 0],[38, 2]]";
            
            Assert.AreEqual(strExpected, $"[{string.Join(",", result.Select(tuple => $"[{tuple[0]}, {tuple[1]}]"))}]");
        }
    }
}
